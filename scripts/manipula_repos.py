...
novo_repo = ManipulaRepositorios('igoriafxd')
...
novo_repo.add_arquivo(nome_repo, 'linguagens_amzn.csv', './external_data/linguagens_amzn.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_netflix.csv', './external_data/linguagens_netflix.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_spotify.csv', './external_data/linguagens_spotify.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_apple.csv', './external_data/linguagens_apple.csv')
